      ...
      <template v-else>
        ...
        <div class="card mb-6">
            ...
            >
              <div class="flex items-start gap-3">
                ...
                <template v-if="hasAnswered">
                  <span v-if="optIndex === currentQuestion.correctIndex" class="text-green-600">
                    <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
                      <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
                    </svg>
                  </span>
                  <span v-else-if="optIndex === confirmedAnswer" class="text-red-600">
                    <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div v-if="hasAnswered" class="mt-6">
            ...
            <!-- Explanation -->
            <div v-if="currentQuestion.explanation" class="mt-4 p-4 bg-blue-50 rounded-lg border border-blue-100">
